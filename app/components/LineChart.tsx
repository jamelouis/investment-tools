...
const LineChartWithBrush = ({ data, mark, onMarkClicked, range }) => {
  ...
  useEffect(() => {
    ...
    const margin2 = { top: 530, right: 30, bottom: 30, left: 60 };
    ...
    focus
      ...
      .on("mouseover", (event, d) => {
        ...
        tooltip
          .html(
            `📅: ${d3.timeFormat("%Y-%m-%d")(d.date)} <br/>数值: ${d.value} <br/> <a href="${d.url}" target="_blank">点击查看发车文章</a>`,
          )
